...
describe ".displayManager" do
  let(:male_record)   { Record.new({last_name: "foo", first_name: "bar", gender: "male", date_of_birth: "3/3/1965", favorite_color: "red"})}
  let(:female_record) { Record.new({last_name: "baz", first_name: "quz", gender: "female", date_of_birth: "4/2/1966", favorite_color: "yellow"})}
